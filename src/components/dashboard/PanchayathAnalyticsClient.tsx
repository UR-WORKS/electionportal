...
import { Card, Badge } from './MandalDashboardClient';
...
export default function PanchayathAnalyticsClient({
  allCandidates,
  boothPerformance,
  candidateId
}: {
  allCandidates: any[];
  boothPerformance: any[];
  candidateId: number;
}) {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <CustomCard title="VOTE SHARE (POLLED)" subtitle="Distribution of votes in this panchayath">
        ...
        <CustomCard title="POLLED VS PREDICTED" subtitle=" Turnout analysis by candidate">
          <div className="h-[300px] w-full">
            <ResponsiveContainer width="100%" height="100%">
      ...
      {/* Booth-wise Performance (Our Candidate) */}
      <CustomCard title="BOOTH PERFORMANCE (OUR CANDIDATE)" subtitle="Performance breakdown by individual booth">
        <div className="h-[400px] w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={boothPerformance} layout="vertical" margin={{ left: 40, right: 40 }}>
